...
public class SeleniumUtil {
    ...
    public static Logger logger = LogManager.getLogger(SeleniumUtil.class.getName());
    ...
    public void type(By byElement, String key) {
        try {
            findElementBy(byElement).clear();  //2018-06-29 11:06
    ...
    /**处理模态对话框，来源：http://www.51testing.com/html/59/n-2513659.html*/
    //临时添加，经测试可用，待修改
    //getElementsBy系列方法只有TagName、Id、Name，【】中填写@LinkText经测无效20181612
    public void submit(By by , String buttonNum) {
    	String js = "setTimeout(function(){document.getElementsByTagName('button')[" + buttonNum + "].click()},1000)";
